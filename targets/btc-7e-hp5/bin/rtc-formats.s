...
rtc_get_cold_item_date_format:
	...
	.set	noreorder
	.set	nomacro
	lui	$2,%hi(g_ColdItemData+59)
	jr	$31
	lbu	$2,%lo(g_ColdItemData+59)($2)
...
rtc_get_cold_item_time_format:
	...
	.set	noreorder
	.set	nomacro
	lui	$2,%hi(g_ColdItemData+77)
	jr	$31
	lbu	$2,%lo(g_ColdItemData+77)($2)
