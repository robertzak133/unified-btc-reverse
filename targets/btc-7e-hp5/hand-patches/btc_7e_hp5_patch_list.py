...
firmware_bundle_a_patch_list['firmware_ID0']['change_from_bytes'] = bytes("BTC7EH5_M05100F", 'utf-8');
firmware_bundle_a_patch_list['firmware_ID0']['change_to_bytes']   = bytes("WWL7EH5_230104A", 'utf-8');

firmware_bundle_a_patch_list['firmware_ID1'] = {}
firmware_bundle_a_patch_list['firmware_ID1']['start_offset'] = 0x2d653c;
firmware_bundle_a_patch_list['firmware_ID1']['change_from_bytes'] = bytes("BTC7EH5_M05100F", 'utf-8');
firmware_bundle_a_patch_list['firmware_ID1']['change_to_bytes']   = bytes("WWL7EH5_230104A", 'utf-8');
...
extended_SDpower_patch_list['extend_video']['change_from_jump'] = 'jal.check_remaining_sd_capacity'
