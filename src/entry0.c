...
void print_disk_handle(uint param_1) {
#ifdef ERROR_PRINT
  set_pre_printf_state();
  tty_printf("Error::WBWL - print_disk_handle not implemented in this patched firmware version");
...
*** ERROR: Unrecognized/unspecified camera target ****
